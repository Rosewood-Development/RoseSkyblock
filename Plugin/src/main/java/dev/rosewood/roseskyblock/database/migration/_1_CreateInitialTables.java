...
public class _1_CreateInitialTables extends DataMigration {
    ...
    public void migrate(DatabaseConnector connector, Connection connection, String tablePrefix) throws SQLException {
        ...
        String islandData = "CREATE TABLE " + tablePrefix + "island (" +
        ...
        String islandMember = "CREATE TABLE " + tablePrefix + "island_member (" +
                              "id INTEGER PRIMARY KEY " + autoIncrement + ", " +
        ...
        String islandGroup = "CREATE TABLE " + tablePrefix + "island_group (" +
                             "id INTEGER PRIMARY KEY " + autoIncrement + ", " +
        ...
        String islandSettings = "CREATE TABLE " + tablePrefix + "island_settings (" +
                                "id INTEGER PRIMARY KEY " + autoIncrement + ", " +
                                "border VARCHAR(10) NOT NULL)";

        try (Statement statement = connection.createStatement()) {
            statement.addBatch(islandData);
            statement.addBatch(islandMember);
            statement.addBatch(islandGroup);
